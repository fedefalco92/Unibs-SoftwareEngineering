...
public class ClasseEquivalenza {
	...
	private Vector<String> insiemeAttivita;		//Totale delle attivita' prese in ingresso dal modello
	...
	private void settaIdentificatorePosizione(){
		...
		Vector<Cammino> percorsiOK = istanzaProva.getEsitoOK();
